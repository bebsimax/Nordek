...
public class SaveEasyNounRepeatCommand : CommandBase
{
    private readonly NavigationService<RepeatViewModel> _navigationService;
    private RepeatNounsViewModel _viewmodel;

    public SaveEasyNounRepeatCommand(NavigationService<RepeatViewModel> navigationService,
    ...
    {
        SqliteDataAccess.AddNounRepeat(_viewmodel.n, Globals.easy.difficulty);
