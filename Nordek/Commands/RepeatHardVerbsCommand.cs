...
public class RepeatHardVerbsCommand : CommandBase
{
    ...
    public RepeatHardVerbsCommand(RepeatViewModel viewmodel, ParameterNavigationService<Verbs, RepeatVerbsViewModel> navigationService)
    {
    ...
    public override void Execute(object parameter)
    {
        ...
        _navigationService.Navigate(_viewmodel.ObjectsToRepeat.verbsDict[Globals.hard.difficulty]);
    }
}