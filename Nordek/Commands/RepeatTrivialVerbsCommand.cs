...
public class RepeatTrivialVerbsCommand : CommandBase
{
    ...
    public RepeatTrivialVerbsCommand(RepeatViewModel viewmodel, ParameterNavigationService<Verbs, RepeatVerbsViewModel> navigationService)
    {
    ...
    public override void Execute(object parameter)
    {
        ...
        _navigationService.Navigate(_viewmodel.ObjectsToRepeat.verbsDict[Globals.trivial.difficulty]);
    }
}